...
const hagenArtists: Artist[] = [
  ...
  },
  {
    ...
    title: 'Enda Kaldere',
    time: '',
    description: 'Hurra! Enda Kaldere kommer til Fosskok-festivalen!\nEnda Kaldere er ei sang- og spellemannsgruppe fra Lørenskog, og består av Finn Evensen, Ole Jørgen Holt Hanssen, Roar Vangen og Jon Haaland.\n\nGruppa ble unnfanget da det gikk av en sprengladning under byggingen av Riksvei 159, like ved det som en gang var Pokerskauen.\nNavnet Enda Kaldere rappet de fra en butikk på Visperud, som alltid reklamerte med enda kaldere drikke enn nabosjappa på heite sommerdager.\n\nOm det ringer en bjelle for deg, så er ikke det så rart; gruppas medlemmer har alle en fortid i gruppa Bjelleklang. Lørenskog-kara forteller, at de alltid utfordrer seg sjøl, både med instrumentene (det er mange av dem!) og teknikken, og de legger sjela i å låte lørenskausk, - selv om de også henter fram musikk som har seilt langveisfra over mange landegrenser.\n\nNå gleder de seg til å hamre løs ved Hammersberget, og så kan vi jo drømme om at det kommer til å fosskoke i selveste Olavskilden!'
  },
  {
    image: '/images/festival/placeholder.png',
    title: 'Soap',
