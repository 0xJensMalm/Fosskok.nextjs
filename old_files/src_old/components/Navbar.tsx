      ...
      <div className={styles.navContainer}>
        ...
        <div className={styles.navRight}>
          <div className={styles.socialIcons}>
            <a href="https://www.instagram.com/fosskok/" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="Instagram">
            ...
            <a href="https://www.facebook.com/fosskok" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="Facebook">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
